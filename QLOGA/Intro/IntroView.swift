                    ...
                    NavigationLink(destination: ProviderSearchView()) {
                        VStack(alignment: .center, spacing: 10) {
                            Image("ProviderSearchIntro")
								...
								.padding([.horizontal, .top], 5)
                            //                        .shadow(color: .lightGray.opacity(0.5), radius: 3)
                            Text("Provider search").foregroundColor(.black).font(.system(size: 16, weight: .medium, design: .rounded)).lineLimit(1)
                                .padding(.horizontal, -20)
                        }.padding(.bottom, 10).padding(.horizontal,25)
                    ...
                    NavigationLink(destination: EnrollmentInfoView()) {
                        VStack(alignment: .center, spacing: 10) {
                            Image("BecomeProviderIntro")
								...
								.padding([.horizontal, .top], 5)
                            //                        .shadow(color: .lightGray.opacity(0.5), radius: 3)
                            Text("Become a provider").foregroundColor(.black).font(.system(size: 16, weight: .medium, design: .rounded)).padding(.horizontal, -20).lineLimit(1)
						}.padding(.bottom, 10).padding(.horizontal,25)
							.overlay(
								RoundedRectangle(cornerRadius: 16)
									.stroke(Color.lightGray.opacity(0.5), lineWidth: 1)
