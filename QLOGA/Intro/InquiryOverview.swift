                    ...
                    VStack {
                        Group  {
                            ...
                            NavigationLink(destination: SelectedServiceDetailView(serviceType: .Kitchen)) {
                                HStack(alignment: .center) {
                                    VStack(alignment: .leading, spacing: 10) {
                                        Text("Windows cleaning") .foregroundColor(Color.black)
                            ...
                            NavigationLink(destination: SelectedServiceDetailView(serviceType: .Kitchen)) {
                                HStack(alignment: .center) {
                                    VStack(alignment: .leading, spacing: 10) {
                                        Text("Kitchen cleaning") .foregroundColor(Color.black)
                                            .multilineTextAlignment(.leading)
                                            .font(Font.system(size: 17, weight: .regular, design: .rounded))
                                        Text("Rate (£ / hour): 21.00")
                                            .foregroundColor(Color.lightGray)
                            ...
                            NavigationLink(destination: SelectedServiceDetailView(serviceType: .Kitchen)) {
                                HStack(alignment: .center) {
                                    VStack(alignment: .leading, spacing: 10) {
                                        Text("Bedroom or living room cleaning") .foregroundColor(Color.black)
                                            .multilineTextAlignment(.leading)
                                            .font(Font.system(size: 17, weight: .regular, design: .rounded))
                                        Text("Rate (£ / hour): 21.00")
                                            .foregroundColor(Color.lightGray)
                        ...
                        NavigationLink(destination: InquiryServicesView()) {
                            HStack{
                                ...
                                //                            .shadow(color: Color.black, radius: 1, x: 1, y: 1)
                                    .font(.system(size: 20, weight: .regular, design: .default)).foregroundColor(.Green).frame(width: UIScreen.main.bounds.width - 42, height: 50)
                        ...
                        VStack {
                            Group  {
                                ...
                                NavigationLink(destination: ProviderOverview(isButtonShows: false)) {
                                    HStack(alignment: .center) {
                                        Text("Provider details") .foregroundColor(Color.black)
                                            .multilineTextAlignment(.leading)
                                            .font(Font.system(size: 17, weight: .regular, design: .rounded))
