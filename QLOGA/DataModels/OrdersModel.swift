...
struct OrderStatusRecord: Codable {
    ...
    var actorId: Int
    var action, note, status, display: String
...
[
    ...
    OrderContent(statusRecord:
                 ...
                 serviceDate: getDate(from: "2021-06-22 00:00:00", "YYYY-MM-DD HH:mm:ss"),
                 services: [
