...
let Customers: [Customer] = [
    ...
    Customer(id: 4, name: "Anna", middleMame: "", surname: "Hilkevich", maidenName: "", birthday: getDate(from: "27/11/99")!, phone: "89990006666", email: "", address: Address(isBussinessOnly: true, postcode: "EH2 2ER", town: "Edinburgh", street: "Princes Street", building: "50", apt: "32", 55.75207, -2.90768, country: "Anna Hilkevich"), languages: [Language.English, Language.French, Language.Germany], verifications: [.IDs, .Phone, .Address], familyRole: .Brother, avatar: "ReviewAvatar", reviews: testReviews, rating: 4.7, distance: 11, services: [StaticCategories[10]!, StaticCategories[20]!, StaticCategories[30]!, StaticCategories[40]!, StaticCategories[50]!]),
