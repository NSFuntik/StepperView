...
struct Webview: UIViewRepresentable {
    ...
    public init(dynamicHeight: Binding<CGFloat>, webview: WKWebView = WKWebView(), html: String
               , lineHeight: CGFloat? = nil, imageRadius: CGFloat? = nil, fontType: fontType? = nil, colorScheme: colorScheme? = nil, colorImportant: Bool? = true, linkOpenType: linkOpenType? = nil, linkColor: ColorSet? = nil
    ) {
        ...
        self.linkOpenType = .SFSafariView
